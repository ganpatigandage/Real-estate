  ...
  return (
    <section id='about' className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} w-full m-auto lg:px-40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10`}>
      ...
      <div className='flex flex-col justify-center items-start gap-8'>
        <h1 data-aos="zoom-in" className='text-red-500 text-[30px] dark:text-white'>WHO WE ARE </h1>
        ...
        <p data-aos="zoom-in" data-aos-delay="400" className='text-xl text-gray-600 dark:text-white text-justify'>Pune is home to several prestigious universities and research institutions, attracting students from across India and abroad. Over the past two decades, Pune has also emerged as a major IT hub, with areas like Hinjewadi, Kharadi, and Magarpatta becoming centers of innovation and employment.</p>
