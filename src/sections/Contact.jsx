    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} pb-20 `}>
      <section id='contact' className={`${darkMode ? 'dark bg-gray-800' : 'light  bg-red-100'} lg:w-[95%] w-full h-fit m-auto rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:px-36 px-6 py-20 gap-10`}>
        <div data-aos="zoom-in" className='bg-white  dark:bg-black p-10 flex flex-col justify-center items-start gap-4 rounded-xl'>
          ...
          <input type="mobile" placeholder='Enter your mobile number' className='w-full px-6 py-3 border-2 border-gray-200 rounded-xl' />
        ...
        <div className='flex flex-col justify-center items-start gap-8 lg:p-20 p-6'>
          ...
          <h1 data-aos="zoom-in" data-aos-delay="400" className='text-black text-[40px] font-semibold leading-10 dark:text-white '>Every step in the process of developing a dream home,should be effortless and rewarding. We want to continue creating a dynamic market environment through technologies in order to make this possible. </h1>
          <p data-aos="zoom-in" data-aos-delay="600" className='text-xl text-gray-600 text-justify dark:text-white' >We represent a dynamic and modern future in real estate services and provide a cutting-edge and original approach.</p>
          <button data-aos="zoom-in" className='bg-red-600 text-md px-8 py-3 text-white font-semibold rounded-xl hover:bg-black dark:hover:bg-red-700 cursor-pointer'>SEND EMAIL </button> 
        </div>
