    ...
    <div className={`${darkMode ? 'bg-black' : 'light bg-transparent'}`}>
      <section id='testimonials' className='lg-w-[95%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-start lg:px-20 px-6 py-20 gap-20'>
        <div className='flex flex-col justify-center items-start gap-4'>
          <h1 data-aos="zoom-in" className='text-red-500 text-[30px] dark:text-white'>OUR CLIENTS</h1>
              ...
              <div data-aos="zoom-in" data-aos-delay="200" key={index} className='bg-white dark:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full'>
                <div className='flex justify-start items-center w-full gap-4'>
                  <img
                    src={item.image}
                    alt={item.name}
                    className='w-[70px] h-[70px] object-cover rounded-full transform hover:scale-110 transition-transform duration-300'
                  />
